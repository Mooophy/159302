...
void drawInvertedPendulumWorld(){
   ...
   //~ setcolor(YELLOW);
	...
	outtextxy((deviceBoundary.x2 - textwidth("START-UP CODE by:  n.h.reyes@massey.ac.nz")), deviceBoundary.y2 + textheight("H"),"START-UP CODE by:  n.h.reyes@massey.ac.nz  (C) Massey University 2019");
}
...
void runInvertedPendulum(){
    ...
    prevState.x = -1.0;
	prevState.angle = 15.0 * (3.14/180);  //initial angle  = 35 degrees
